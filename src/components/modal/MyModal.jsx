...
const MyModal = ({form,card,close,visibility}) => {
  ...
  return <Backdrop close={close} visibility={visibility}>
    {
      !form?
        <div onClick={(e)=>e.stopPropagation()} className="z-20 max-w-[340px] md:max-w-lg bg-white box-content py-6 px-3 md:py-10 md:px-8">
        <h1 className="text-xl md:text-4xl mb-3  font-bold md:mb-6">{card.title}</h1>
