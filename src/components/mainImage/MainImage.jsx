...
const MainImage = () => {
  return <div className=" w-full relative flex justify-center items-center">
    <div className="absolute z-10 text-center text-white">
      <h1 className=" text-6xl my-4">Мы – супермодели!</h1>
      <h2 className="text-4xl my-4">В мир несем красоту!</h2>
      <span className="text-xl my-8">Модельная студия создана специально для тебя</span>
    </div>
